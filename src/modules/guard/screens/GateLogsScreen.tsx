...
import { useGateLogs } from "../hooks/useGateLogs";
import { styles, createTextColorStyle, createTextColorStyle2, createTextColorStyle3, createTextColorStyle4, createTextColorStyle5, createTextColorStyle6 } from "../styles/screens/GateLogsScreen.styles";
import { useMessages as useGeneratedUiMessages } from "../../../messages/useMessages";
export function GateLogsScreen({ navigation }: NavigationOnlyScreenProps) {
    const localizedUiText = useGeneratedUiMessages().uiLiterals;
    const { colors } = useAppTheme();
    const { submit, isSubmitting } = useGateLogs();
    ...
    return (<ScreenContainer>
      <SafeAreaView style={styles.safe} edges={['top', 'left', 'right']}>
        <ResponsivePageHeader title={localizedUiText.m_f986ebb8c938} onBack={() => navigation.goBack()}/>
        <ScrollView contentContainerStyle={styles.content}>
          <AppCard style={styles.appCardMarginBottom}>
            ...
            <Text style={[styles.desc, createTextColorStyle3(colors.textSecondary)]}>{localizedUiText.m_43e12a5c58e1}</Text>
          ...
          <AppCard style={styles.appCardMarginBottom2}>
            ...
            <DataRow label={localizedUiText.m_29894a6ccc25} value="GATE_LOGS"/>
            <DataRow label={localizedUiText.m_6d5c369331cb} value="useGateLogs"/>
            <DataRow label={localizedUiText.m_150f3e5e3c03} value="Filter logs by gate, guard, type and date"/>
          </AppCard>
          ...
          <AppCard style={styles.appCardMarginBottom3}>
            ...
            {success ? (<View style={styles.successBox}>
                ...
                <Text style={[styles.actionText, createTextColorStyle6(colors.textPrimary)]}>{localizedUiText.m_95fb614ba397}</Text>
