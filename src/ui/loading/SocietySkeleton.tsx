...
export function SocietyShimmerProvider({ children, animate = true }: {
...
export function SocietySkeleton({ width = '100%', height = 16, borderRadius = Radius.sm, style, testID, animate = true, }: SocietySkeletonProps) {
