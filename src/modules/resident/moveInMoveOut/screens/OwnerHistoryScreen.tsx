...
import { styles, createTextColorStyle, createTextColorStyle2, createTextColorStyle3, createTextColorStyle4, createTextColorStyle5, createTextColorStyle6 } from "../styles/screens/OwnerHistoryScreen.styles";
import { useMessages as useGeneratedUiMessages } from "../../../../messages/useMessages";
export function OwnerHistoryScreen({ navigation }: NavigationOnlyScreenProps) {
    const localizedUiText = useGeneratedUiMessages().uiLiterals;
    const { colors } = useAppTheme();
    const { submit, isSubmitting } = useOwnerHistory();
    ...
    return (<ScreenContainer>
      <SafeAreaView style={styles.safe} edges={['left', 'right']}>
        <ResponsivePageHeader title={localizedUiText.m_5eff04308e23} onBack={() => navigation.goBack()}/>
        <ScrollView contentContainerStyle={styles.content}>
          <AppCard style={styles.appCardMarginBottom}>
            ...
            <Text style={[styles.desc, createTextColorStyle3(colors.textSecondary)]}>{localizedUiText.m_c6dde59d64ac}</Text>
          ...
          <AppCard style={styles.appCardMarginBottom2}>
            ...
            <DataRow label={localizedUiText.m_29894a6ccc25} value="OWNER_HISTORY"/>
            <DataRow label={localizedUiText.m_6d5c369331cb} value="useOwnerHistory"/>
            <DataRow label={localizedUiText.m_150f3e5e3c03} value="Open previous owner detail and linked documents"/>
          </AppCard>
          ...
          <AppCard style={styles.appCardMarginBottom3}>
            ...
            {success ? (<View style={styles.successBox}>
                ...
                <Text style={[styles.actionText, createTextColorStyle6(colors.textPrimary)]}>{localizedUiText.m_0bdb66a6c512}</Text>
