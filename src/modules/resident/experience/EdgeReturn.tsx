...
export function SocietyReturnControl({ onPress, semantic = 'back', accessibilityLabel, style, testID = 'society-return-control', }: SocietyReturnControlProps) {
    ...
    const defaultLabel = semantic === 'close' || semantic === 'cancel'
    ...
    return (<AnimatedPressable onPress={onPress} onPressIn={handlePressIn} onPressOut={handlePressOut} accessibilityRole="button" accessibilityLabel={accessibilityLabel ?? defaultLabel} testID={testID} hitSlop={{ top: 8, bottom: 8, left: 8, right: 8 }} style={[
            styles.edgeReturn,
            {
      ...
      <Ionicons name={ICON_MAP[semantic]} size={semantic === 'close' || semantic === 'cancel' ? 20 : 22} color={sem.text.primary}/>
    </AnimatedPressable>);
}
