...
export const styles = StyleSheet.create({
    ...
    time: { ...Typography.caption, color: Colors.textMuted, marginTop: Spacing.xs, marginBottom: Spacing.md },
    overrideButton: { height: 40, backgroundColor: '#FEF3C7', borderRadius: 6, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#F59E0B' },
    overrideButtonText: { ...Typography.button, color: '#D97706', fontSize: 13 },
    viewWidth: { width: 24 }
});
