...
export function createPressableBackgroundColorBorderColorStyle(backgroundColorValue: "#F4F6FB" | "#080D18", borderColorValue: "#253149" | "#E2E6EE") {
    return {
        backgroundColor: backgroundColorValue,
        borderColor: borderColorValue
    } as const;
}
export function createViewBackgroundColorBorderColorStyle2(backgroundColorValue: "#052E16" | "#DCFCE7", borderColorValue: "#198A59" | "#5BD39A") {
    return {
        backgroundColor: backgroundColorValue,
        borderColor: borderColorValue
    } as const;
