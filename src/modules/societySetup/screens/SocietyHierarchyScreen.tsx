...
import { useSocietyHierarchy } from "../hooks/useSocietyHierarchy";
import { styles, createTextColorStyle, createTextColorStyle2, createTextColorStyle3, createTextColorStyle4, createTextColorStyle5, createTextColorStyle6 } from "../styles/screens/SocietyHierarchyScreen.styles";
import { useMessages as useGeneratedUiMessages } from "../../../messages/useMessages";
export function SocietyHierarchyScreen({ navigation }: {
    navigation: {
    ...
    const { submit, isSubmitting } = useSocietyHierarchy();
    ...
    return (<ScreenContainer>
      <SafeAreaView style={styles.safe} edges={['top', 'left', 'right']}>
        <ResponsivePageHeader title={localizedUiText.m_6daae40e3975} onBack={() => navigation.goBack()}/>
        <ScrollView contentContainerStyle={styles.content}>
          <AppCard style={styles.appCardMarginBottom}>
            ...
            <Text style={[styles.desc, createTextColorStyle3(colors.textSecondary)]}>{localizedUiText.m_ddab35cee5fb}</Text>
          ...
          <AppCard style={styles.appCardMarginBottom2}>
            ...
            <DataRow label={localizedUiText.m_29894a6ccc25} value="SOCIETY_HIERARCHY"/>
            <DataRow label={localizedUiText.m_6d5c369331cb} value="useSocietyHierarchy"/>
            <DataRow label={localizedUiText.m_150f3e5e3c03} value="Add tower wing floor wing locally in mock state"/>
          </AppCard>
          ...
          <AppCard style={styles.appCardMarginBottom3}>
            ...
            {success ? (<View style={styles.successBox}>
                ...
                <Text style={[styles.actionText, createTextColorStyle6(colors.textPrimary)]}>{localizedUiText.m_24b038e67814}</Text>
