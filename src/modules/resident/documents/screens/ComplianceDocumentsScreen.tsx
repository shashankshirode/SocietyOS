...
import { styles, createTextColorStyle, createTextColorStyle2, createTextColorStyle3, createTextColorStyle4, createTextColorStyle5, createTextColorStyle6 } from "../styles/screens/ComplianceDocumentsScreen.styles";
import { useMessages as useGeneratedUiMessages } from "../../../../messages/useMessages";
export function ComplianceDocumentsScreen({ navigation }: NavigationOnlyScreenProps) {
    const localizedUiText = useGeneratedUiMessages().uiLiterals;
    const { colors } = useAppTheme();
    const { submit, isSubmitting } = useDocumentsByCategory();
    ...
    return (<ScreenContainer>
      <SafeAreaView style={styles.safe} edges={['left', 'right']}>
        <ResponsivePageHeader title={localizedUiText.m_2630b983437d} onBack={() => navigation.goBack()}/>
        <ScrollView contentContainerStyle={styles.content}>
          <AppCard style={styles.appCardMarginBottom}>
            ...
            <Text style={[styles.desc, createTextColorStyle3(colors.textSecondary)]}>{localizedUiText.m_dd4da3268439}</Text>
          ...
          <AppCard style={styles.appCardMarginBottom2}>
            ...
            <DataRow label={localizedUiText.m_29894a6ccc25} value="COMPLIANCE_DOCUMENTS"/>
            <DataRow label={localizedUiText.m_6d5c369331cb} value="useDocumentsByCategory"/>
            <DataRow label={localizedUiText.m_150f3e5e3c03} value="Filter compliance documents"/>
          </AppCard>
          ...
          <AppCard style={styles.appCardMarginBottom3}>
            ...
            {success ? (<View style={styles.successBox}>
                ...
                <Text style={[styles.actionText, createTextColorStyle6(colors.textPrimary)]}>{localizedUiText.m_267a75c6e17c}</Text>
