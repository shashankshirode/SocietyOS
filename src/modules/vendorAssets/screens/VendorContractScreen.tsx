...
import { useVendorContract } from "../hooks/useVendorContract";
import { styles, createTextColorStyle, createTextColorStyle2, createTextColorStyle3, createTextColorStyle4, createTextColorStyle5, createTextColorStyle6 } from "../styles/screens/VendorContractScreen.styles";
import { useMessages as useGeneratedUiMessages } from "../../../messages/useMessages";
export function VendorContractScreen({ navigation }: {
    navigation: {
    ...
    const { submit, isSubmitting } = useVendorContract();
    ...
    return (<ScreenContainer>
      <SafeAreaView style={styles.safe} edges={['top', 'left', 'right']}>
        <ResponsivePageHeader title={localizedUiText.m_6390d6616f60} onBack={() => navigation.goBack()}/>
        <ScrollView contentContainerStyle={styles.content}>
          <AppCard style={styles.appCardMarginBottom}>
            ...
            <Text style={[styles.desc, createTextColorStyle3(colors.textSecondary)]}>{localizedUiText.m_c20dd14cba00}</Text>
          ...
          <AppCard style={styles.appCardMarginBottom2}>
            ...
            <DataRow label={localizedUiText.m_29894a6ccc25} value="VENDOR_CONTRACT"/>
            <DataRow label={localizedUiText.m_6d5c369331cb} value="useVendorContract"/>
            <DataRow label={localizedUiText.m_150f3e5e3c03} value="Show contract period, documents and renewal reminder"/>
          </AppCard>
          ...
          <AppCard style={styles.appCardMarginBottom3}>
            ...
            {success ? (<View style={styles.successBox}>
                ...
                <Text style={[styles.actionText, createTextColorStyle6(colors.textPrimary)]}>{localizedUiText.m_71427ec86f23}</Text>
