...
import { useInventoryIssueReturn } from "../hooks/useInventoryIssueReturn";
import { styles, createTextColorStyle, createTextColorStyle2, createTextColorStyle3, createTextColorStyle4, createTextColorStyle5, createTextColorStyle6 } from "../styles/screens/InventoryIssueReturnScreen.styles";
import { useMessages as useGeneratedUiMessages } from "../../../messages/useMessages";
export function InventoryIssueReturnScreen({ navigation }: {
    navigation: {
    ...
    const { submit, isSubmitting } = useInventoryIssueReturn();
    ...
    return (<ScreenContainer>
      <SafeAreaView style={styles.safe} edges={['top', 'left', 'right']}>
        <ResponsivePageHeader title={localizedUiText.m_501590e18d09} onBack={() => navigation.goBack()}/>
        <ScrollView contentContainerStyle={styles.content}>
          <AppCard style={styles.appCardMarginBottom}>
            ...
            <Text style={[styles.desc, createTextColorStyle3(colors.textSecondary)]}>{localizedUiText.m_6ecece425234}</Text>
          ...
          <AppCard style={styles.appCardMarginBottom2}>
            ...
            <DataRow label={localizedUiText.m_29894a6ccc25} value="INVENTORY_ISSUE_RETURN"/>
            <DataRow label={localizedUiText.m_6d5c369331cb} value="useInventoryIssueReturn"/>
            <DataRow label={localizedUiText.m_150f3e5e3c03} value="Issue and return inventory item in mock state"/>
          </AppCard>
          ...
          <AppCard style={styles.appCardMarginBottom3}>
            ...
            {success ? (<View style={styles.successBox}>
                ...
                <Text style={[styles.actionText, createTextColorStyle6(colors.textPrimary)]}>{localizedUiText.m_5748b590ca5f}</Text>
