...
export const styles = StyleSheet.create({
    ...
    left: { flex: 1 },
    event: { ...Typography.body, fontWeight: '600', color: Colors.textPrimary },
    actor: { ...Typography.bodySmall, color: Colors.textSecondary, marginVertical: 2 },
    text: { ...Typography.caption, color: Colors.textMuted },
    right: { alignItems: 'flex-end', justifyContent: 'center' },
    time: { ...Typography.caption, color: Colors.textPrimary, fontWeight: '500' },
