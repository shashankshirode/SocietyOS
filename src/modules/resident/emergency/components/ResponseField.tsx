...
export function ResponseField({ event, unitName, categoryLabel, accentColor, }: ResponseFieldProps) {
    ...
    return (<View style={styles.container}>
      ...
      <View style={styles.constellationWrapper}>
        ...
        <View style={styles.respondersRow}>
          {deliveries.slice(0, 3).map((delivery) => {
            ...
            return (<View key={delivery.recipientId} style={styles.responderNode}>
                <View style={[
                  ...
                  <Ionicons name={isDeliveryAck ? 'shield-checkmark' : 'shield-outline'} size={16} color={isDeliveryAck ? emergencyTheme.acknowledged : emergencyTheme.textSecondary}/>
                </View>
      ...
      <View style={styles.traceContainer}>
        ...
        <View style={styles.traceList}>
          ...
          {event.status !== 'initiated' && (<View style={styles.traceRow}>
              <View style={[styles.traceDot, { backgroundColor: emergencyTheme.acknowledged }]}/>
              <SafeText variant="tiny" style={[styles.traceTime, { color: emergencyTheme.textSecondary }]}>
                {new Date(event.triggeredAt).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
              </SafeText>
          ...
          {isAcknowledged && (<View style={styles.traceRow}>
              <View style={[styles.traceDot, { backgroundColor: emergencyTheme.acknowledged }]}/>
              <SafeText variant="tiny" style={[styles.traceTime, { color: emergencyTheme.textSecondary }]}>
