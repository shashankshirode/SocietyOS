...
import { useCreatePetNuisanceIssue } from "../hooks/useCreatePetNuisanceIssue";
import { styles, createTextColorStyle, createTextColorStyle2, createTextColorStyle3, createTextColorStyle4, createTextColorStyle5, createTextColorStyle6 } from "../styles/screens/PetNuisanceIssueScreen.styles";
import { useMessages as useGeneratedUiMessages } from "../../../../messages/useMessages";
export function PetNuisanceIssueScreen({ navigation }: NavigationOnlyScreenProps) {
    const localizedUiText = useGeneratedUiMessages().uiLiterals;
    const { colors } = useAppTheme();
    const { submit, isSubmitting } = useCreatePetNuisanceIssue();
    ...
    return (<ScreenContainer>
      <SafeAreaView style={styles.safe} edges={['left', 'right']}>
        <ResponsivePageHeader title={localizedUiText.m_492d98729b2b} onBack={() => navigation.goBack()}/>
        <ScrollView contentContainerStyle={styles.content}>
          <AppCard style={styles.appCardMarginBottom}>
            ...
            <Text style={[styles.desc, createTextColorStyle3(colors.textSecondary)]}>{localizedUiText.m_0849bc221f08}</Text>
          ...
          <AppCard style={styles.appCardMarginBottom2}>
            ...
            <DataRow label={localizedUiText.m_29894a6ccc25} value="PET_NUISANCE_ISSUE"/>
            <DataRow label={localizedUiText.m_6d5c369331cb} value="useCreatePetNuisanceIssue"/>
            <DataRow label={localizedUiText.m_150f3e5e3c03} value="Submit pet nuisance issue with polite notification text"/>
          </AppCard>
          ...
          <AppCard style={styles.appCardMarginBottom3}>
            ...
            {success ? (<View style={styles.successBox}>
                ...
                <Text style={[styles.actionText, createTextColorStyle6(colors.textPrimary)]}>{localizedUiText.m_3db86699e698}</Text>
