...
import { useAmcReminders } from "../hooks/useAmcReminders";
import { styles, createTextColorStyle, createTextColorStyle2, createTextColorStyle3, createTextColorStyle4, createTextColorStyle5, createTextColorStyle6 } from "../styles/screens/AmcReminderDashboardScreen.styles";
import { useMessages as useGeneratedUiMessages } from "../../../messages/useMessages";
export function AmcReminderDashboardScreen({ navigation }: {
    navigation: {
    ...
    const { submit, isSubmitting } = useAmcReminders();
    ...
    return (<ScreenContainer>
      <SafeAreaView style={styles.safe} edges={['top', 'left', 'right']}>
        <ResponsivePageHeader title={localizedUiText.m_372f4c6c1f01} onBack={() => navigation.goBack()}/>
        <ScrollView contentContainerStyle={styles.content}>
          <AppCard style={styles.appCardMarginBottom}>
            ...
            <Text style={[styles.desc, createTextColorStyle3(colors.textSecondary)]}>{localizedUiText.m_f629c81ec97a}</Text>
          ...
          <AppCard style={styles.appCardMarginBottom2}>
            ...
            <DataRow label={localizedUiText.m_29894a6ccc25} value="AMC_REMINDER_DASHBOARD"/>
            <DataRow label={localizedUiText.m_6d5c369331cb} value="useAmcReminders"/>
            <DataRow label={localizedUiText.m_150f3e5e3c03} value="Filter expired, expiring soon and active AMCs"/>
          </AppCard>
          ...
          <AppCard style={styles.appCardMarginBottom3}>
            ...
            {success ? (<View style={styles.successBox}>
                ...
                <Text style={[styles.actionText, createTextColorStyle6(colors.textPrimary)]}>{localizedUiText.m_79e04278cc45}</Text>
