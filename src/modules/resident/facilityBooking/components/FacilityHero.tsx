...
interface FacilityHeroProps {
    ...
    readonly nextBookingSummary?: string | Absent;
}
export function FacilityHero({ image, title, subtitle, actionLabel, badgeLabel, onAction, nextBookingSummary, }: FacilityHeroProps) {
    ...
    return (<View style={styles.hero}>
      ...
      <View style={styles.heroScrim}>
        ...
        <Pressable onPress={onAction} accessibilityRole="button" accessibilityLabel={nextBookingSummary ? `Your next booking: ${nextBookingSummary}` : actionLabel} style={({ pressed }) => [
            {
                marginTop: 4,
