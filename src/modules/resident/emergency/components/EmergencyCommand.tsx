      ...
      <View style={styles.container}>
        {onReturnToHome && (
          <Pressable
            ...
            style={[styles.primaryButton, { backgroundColor: emergencyTheme.surfaceRaised, borderColor: emergencyTheme.connector, borderWidth: 1 }]}
          >
      ...
      <View style={styles.container}>
        {onRetry && (
          <Pressable
            onPress={onRetry}
            accessibilityRole="button"
            style={[styles.primaryButton, { backgroundColor: emergencyTheme.core }]}
          >
        ...
        {onCallGateSecurity && (
          <Pressable
            onPress={onCallGateSecurity}
            accessibilityRole="button"
            style={[styles.secondaryButton, { backgroundColor: emergencyTheme.surfaceRaised, borderColor: emergencyTheme.border }]}
          >
